...
namespace FlowerSellingWebsite.Repositories.Implementations
{
    public class OrderRepository : BaseRepository<Order>, IOrderRepository
    {
        ...
        public async Task<(IEnumerable<Order> orders, int totalCount)> GetOrdersWithFiltersAsync(OrderFilterDTO filters)
        {
        ...
        public async Task<Order?> GetOrderWithDetailsByPublicIdAsync(Guid publicId)
        {
            return await _context.Orders
                .Include(o => o.Customer)
                .Include(o => o.Supplier)
        ...
        public async Task<OrderDetail?> GetOrderDetailByPublicIdAsync(Guid publicId)
        {
            return await _context.OrderDetails
                .Include(od => od.Product)
                .Include(od => od.FlowerBatch)
